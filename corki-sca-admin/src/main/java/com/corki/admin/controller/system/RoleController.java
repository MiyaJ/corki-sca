...
//        return roleService.insertRole(role) > 0 ? R.success("新增成功") : R.fail("新增失败");
//    }
//
//    /**
//     * 修改保存角色
...
//        roleService.checkRoleAllowed(role);
//        roleService.checkRoleDataScope(new Long[]{role.getId()});
//        return roleService.authDataScope(role) > 0 ? R.success("修改成功") : R.fail("修改失败");
//    }
//
//    /**
//     * 状态修改
...
//        roleService.checkRoleAllowed(role);
//        role.setUpdateBy(getUsername());
//        return roleService.updateRoleStatus(role) > 0 ? R.success("修改成功") : R.fail("修改失败");
//    }
//
//    /**
//     * 删除角色
...
//        return roleService.deleteRoleByIds(roleIds) > 0 ? R.success("删除成功") : R.fail("删除失败");
//    }
//
//    /**
//     * 获取角色选择框列表
...
//               R.success("取消授权成功") : R.fail("取消授权失败");
//    }
//
//    /**
//     * 批量取消授权用户
