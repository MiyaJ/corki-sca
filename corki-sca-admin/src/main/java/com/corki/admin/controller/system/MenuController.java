...
//        return menuService.insertMenu(menu) > 0 ? R.success("新增成功") : R.fail("新增失败");
//    }
//
//    /**
//     * 修改菜单
...
//        return menuService.updateMenu(menu) > 0 ? R.success("修改成功") : R.fail("修改失败");
//    }
//
//    /**
//     * 删除菜单
...
//        }
//        return menuService.deleteMenuById(menuId) > 0 ? R.success("删除成功") : R.fail("删除失败");
//    }
//
//    /**
//     * 获取当前用户ID
